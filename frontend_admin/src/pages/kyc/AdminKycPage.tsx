...
export const AdminKycPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-12 animate-in fade-in duration-300">
      {/* Header Banner */}
      <div className="glass-panel p-6 rounded-3xl border border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xl">
        <div className="space-y-1">
          <div className="flex items-center gap-2.5">
            ...
            <h1 className="text-xl font-black text-white tracking-wide">
              Thẩm Định & Duyệt Danh Tính Seller (KYC)
            </h1>
          </div>
          <p className="text-xs text-slate-400 pl-11">
            Xem xét thủ công giấy tờ tùy thân CCCD/CMND 2 mặt trước khi mở khóa tính năng phát hành đơn hàng.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={isLoading}
            className="px-4 py-2.5 rounded-xl bg-slate-900/80 hover:bg-slate-800 border border-slate-700 text-slate-300 hover:text-white text-xs font-bold flex items-center gap-2 transition cursor-pointer"
          >
          ...
          <div className="px-3.5 py-2 rounded-xl bg-amber-500/10 border border-amber-500/30 text-amber-300 text-xs font-bold flex items-center gap-2">
            ...
            <span>{totalItems} Hồ Sơ Chờ Xử Lý</span>
          </div>
        </div>
      </div>
      ...
      <div className="glass-panel p-4 rounded-2xl border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
        <div className="relative w-full sm:w-96">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-xl bg-slate-900/80 border border-slate-800 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:border-cyan-500 transition"
          />
        </div>
              ...
              {isLoadingDetail || !detailData ? (
                ...
                <>
                  ...
                  {detailData.duplicateIdWarning && (
                    <div className="p-4 rounded-2xl bg-amber-950/40 border border-amber-500/50 text-amber-200 space-y-2">
                  ...
                  <div className="p-5 rounded-2xl bg-cyan-50 dark:bg-cyan-950/20 border border-cyan-300 dark:border-cyan-500/30 space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs">
                      ...
                      <div className="p-3 rounded-xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 shadow-sm">
                        ...
                        <strong className="text-amber-700 dark:text-amber-300 uppercase tracking-wide font-black">{detailData.idFullName}</strong>
                      </div>
                    </div>
                  </div>
