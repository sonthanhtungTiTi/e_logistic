...
async function seed() {
  ...
  const demoAccounts = [
    ...
    {
      fullName: 'Lê Anh Dũng (Shipper Tân Bình 1)',
      email: 'shipper1.demo@elogistic.vn',
      ...
      maxWeightCapacityKg: 45,
      currentWeightKg: 0,
      currentLocation: { type: 'Point', coordinates: [106.652, 10.792] },
      isActive: true,
      password: hashedPassword,
    },
    {
      fullName: 'Hoàng Minh Tuấn (Shipper Tân Bình 2)',
      email: 'shipper2.demo@elogistic.vn',
      ...
      maxWeightCapacityKg: 45,
      currentWeightKg: 0,
      currentLocation: { type: 'Point', coordinates: [106.653, 10.793] },
      isActive: true,
      password: hashedPassword,
    },
    {
    ...
    {
      fullName: 'Trần Kho Vận (Quản Lý Kho)',
      email: 'warehouse.mgr@elogistic.vn',
    ...
    {
      fullName: 'Lê Kế Toán (Quản Lý Ví & COD)',
      email: 'accountant.demo@elogistic.vn',
      phoneNumber: '0900000051',
      role: 'ACCOUNTANT',
      kycStatus: 'VERIFIED_KYC',
      isActive: true,
      password: hashedPassword,
